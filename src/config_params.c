...
void config_params_init(void) {
    ...
    g_config_params.d6fph_model = (d6fph_sensor_model_t)config_get_int("d6fph_model", s_default_params.d6fph_model);
    g_config_params.hf_sleep_duration_ms = config_get_int("hf_sleep_ms", s_default_params.hf_sleep_duration_ms);
    g_config_params.hf_log_interval_ms = config_get_int("hf_log_int_ms", s_default_params.hf_log_interval_ms);
