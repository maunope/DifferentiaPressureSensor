...
*   **OLED Display & UI**: Features a menu-driven user interface on an OLED display, controlled by a rotary encoder with a push-button. The UI displays:
    ...
    *   System information like persistent uptime and last write time.
    ...
    *   An "About" page with a QR code for the project repository and firmware build timestamp.
...
*   **Web Server**: Can start a web server to allow downloading logged data files directly from a web browser.
