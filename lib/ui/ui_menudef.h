...
const ui_menu_page_t ui_menu_tree[] = {
    {
        ...
        .items = {
            ...
            {.label = "Sampling Mode", .has_submenu = true, .submenu_page_index = 8, .on_btn = NULL},
    ...
    {.title = "Options", .items = {{.label = "Real Time Clock", .has_submenu = true, .submenu_page_index = 2, .on_btn = NULL}, {.label = "File System", .has_submenu = true, .submenu_page_index = 3, .on_btn = NULL}, {.label = "View Config", .has_submenu = false, .on_btn = menu_config_on_btn}, MENU_BACK_ITEM}, .item_count = 4},
    {.title = "Real Time Clock", .items = {{.label = "Sync RTC w/ NTP", .has_submenu = true, .submenu_page_index = 4, .on_btn = NULL}, {.label = "Build ts to RTC", .has_submenu = true, .submenu_page_index = 5, .on_btn = NULL}, MENU_BACK_ITEM}, .item_count = 3},
    {.title = "File System", .items = {{.label = "Stats", .has_submenu = false, .on_btn = menu_fs_stats_on_btn}, {.label = "Format SD Card", .has_submenu = true, .submenu_page_index = 6, .on_btn = NULL}, MENU_BACK_ITEM}, .item_count = 3},
    // Confirmation Pages
